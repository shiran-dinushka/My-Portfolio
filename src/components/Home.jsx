        ...
        h-full px-4 md:flex-row">
            <div className="flex flex-col justify-center h-full">
                ...
                <p className="text-gray-500 py-4 max-w-md">
                    I am undergradate at University of Moratuwa, Sri Lanka.
                    Currently, I am working as trainee software engineer at LiveRoom.
                    I have a passion for developing and learning new technologies.
                </p>
                <div>
